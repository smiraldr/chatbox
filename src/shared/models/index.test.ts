...
import Ionet from 'src/shared/providers/definitions/models/ionet'
...
describe('getModel', () => {
  ...
  it.each([
    ...
    [ModelProviderEnum.Ionet, 'deepseek-ai/DeepSeek-V4.1-Flash', 'https://api.intelligence.io.solutions/api/v1', Ionet],
